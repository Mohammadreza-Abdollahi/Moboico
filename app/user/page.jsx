  ...
  return (
    <>
      <section className="mt-5">
        <section className="relative px-2 py-8 mt-3 bg-white rounded border border-slate-300 flex flex-col md:flex-row gap-12">
          <span className="absolute text-lg top-0 right-5 -translate-y-1/2 bg-white px-2">
            اطلاعات کاربر
          </span>
          <div className="w-full md:w-1/2 flex justify-center md:justify-around items-center">
            <span className="me-1 md:me-3">ایمیل :</span>
            <span>{"mohammad1384abdollahi@gmail.com"}</span>
          </div>
          <div className="w-full md:w-1/2 flex justify-center md:justify-around items-center">
            <span className="me-1 md:me-3">نام کاربری :</span>
            <span>{"Mohammadreza1384"}</span>
          </div>
        </section>
        <section className="flex flex-col md:flex-row justify-between gap-2 md:gap-8">
          <div className="relative w-full min-h-48 px-2 py-8 mt-6 rounded border border-slate-300">
            <span className="absolute text-lg top-0 right-5 -translate-y-1/2 bg-white px-2">
              اخرین سفارشات
            </span>
